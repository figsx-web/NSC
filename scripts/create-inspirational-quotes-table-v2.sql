...
('A melhor maneira de encontrar a si mesmo é perder-se no serviço aos outros.', 'Mahatma Gandhi', 'Líder e Educador')
ON CONFLICT DO NOTHING;

-- Criar índice para melhor performance
CREATE INDEX IF NOT EXISTS idx_inspirational_quotes_author ON inspirational_quotes(author);

-- Comentário na tabela
COMMENT ON TABLE inspirational_quotes IS 'Tabela de frases inspiracionais de educadores e ganhadores do Nobel';
