...
interface GMVProgressBarProps {
  currentGMV: number // Keeping prop name for compatibility, but it will receive commission
}

export function GMVProgressBar({ currentGMV: currentCommission }: GMVProgressBarProps) {
  const targetCommission = 300000 // $300k comissão
  const progressPercentage = Math.min((currentCommission / targetCommission) * 100, 100)

  // Marcos de progresso (approx 10%, 25%, 50%, 100% of 300k)
  const milestones = [
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-xl font-semibold">Meta de Comissão - EUA (Tempo Todo)</h2>
            </div>
          ...
          <div className="relative">
            ...
            {milestones.map((milestone, index) => {
              ...
              return (
                ...
                >
                  {/* Marker Line - Gato para e.g 300k */}
                  {isLastMilestone ? (
          ...
          {progressPercentage >= 100 && (
            <div className="text-center p-4 bg-gradient-to-r from-blue-50 to-cyan-50 dark:from-blue-900/20 dark:to-cyan-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
              ...
              <div className="text-lg font-semibold text-blue-700 dark:text-blue-300">
                Parabéns! Meta de {formatCurrency(targetCommission)} alcançada! 🎉
              </div>
