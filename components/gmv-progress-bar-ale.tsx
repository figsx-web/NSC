...
interface GMVProgressBarAleProps {
    currentGMV: number
}

export function GMVProgressBarAle({ currentGMV: currentCommission }: GMVProgressBarAleProps) {
    const targetCommission = 30000; // €30k comissão (Assuming similar scale or user preference, keeping consistent with UK scale or USA? UK was 30k, USA 300k. Let's assume 30k Euro like UK 30k GBP for now, or match USA? The prompt didn't specify target, only symbols. I will stick to 30k as it is closer to GBP value-wise than 300k, but I should probably check UK file. Actually, if USA is 300k, maybe Ale is 300k? Let's assume 30k for now as it's a regional team like UK. Wait, user said "troque os simbolos". I will use 300k to match USA file I copied from, but change symbols. -- actually `gmv-progress-bar-uk` was 30k? Let's quick check UK file first to be safe. "gmv-progress-bar-uk" was in list. I didn't read it. I'll read it in next step. For now I will write this file with Euro symbols and 300k target same as USA, I can adjust target if needed.)
    // Actually, safe bet is to copy USA logic but swap symbols.
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                            ...
                            <h2 className="text-xl font-semibold">Meta de Comissão - ALE (Tempo Todo)</h2>
                        </div>
                    ...
                    {progressPercentage >= 100 && (
                        <div className="text-center p-4 bg-gradient-to-r from-blue-50 to-cyan-50 dark:from-blue-900/20 dark:to-cyan-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
                            ...
                            <div className="text-lg font-semibold text-blue-700 dark:text-blue-300">
                                Prost! Meta de {formatCurrency(targetCommission)} alcançada! 🎉
                            </div>
